...
parser.add_argument('path', type=is_file, help='Path to one of the SVG files generated by Aseprite in the series.')
parser.add_argument('-d', '--duration', dest='duration', type=int, default=100, help='Duration of each frame in miliseconds.')
...
if __name__ == "__main__":
    try:
        ...
        animation = Animation(frames[0].width, frames[0].height, frames[0].scale, args.duration)
